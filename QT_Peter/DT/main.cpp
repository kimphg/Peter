...
int main(int argc, char *argv[])
{
    ...
    features.push_back("distanceCoeff");
    features.push_back("speedDif");
    features.push_back("rgSpeedDif");
    //features.push_back("Rgspeedkmh");
    features.push_back("accPerpendir");//
    features.push_back("rangeSpeed");//rangeSpeed
